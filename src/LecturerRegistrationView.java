...
/**
 * It's a GUI class that creates a window for the user to register as a lecturer.
 * @author Megat 
 */

public class LecturerRegistrationView extends JFrame  {
  ...
  public  LecturerRegistrationView() {
      ...
      registerLabel = new JLabel("Lecturer Registration Page", SwingConstants.CENTER);
